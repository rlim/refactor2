function [X,Xname,Fc] = spm_5_Volterra(U,bf,V)
% generalized convolution of inputs (U) with basis set (bf)
% FORMAT [X,Xname,Fc] = spm_5_Volterra(U,bf,V);
...
%
% For first order expansions spm_5_Volterra simply convolves the causes
...
% Karl Friston
% $Id: spm_5_Volterra.m 112 2005-05-04 18:20:52Z john $

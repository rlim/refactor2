function [xBF] = spm_5_get_bf(xBF)
% fills in basis function structure
% FORMAT [xBF] = spm_5_get_bf(xBF);
%
...
%
% spm_5_get_bf prompts for basis functions to model event or epoch-related
...
% Karl Friston
% $Id: spm_5_get_bf.m 112 2005-05-04 18:20:52Z john $
%
% CPCA SPM dependancy commented out
% no fourier functions used
...
% model event-related responses - force 'hrf'
%-----------------------------------------------------------------------
if ~isfield(xBF,'name')

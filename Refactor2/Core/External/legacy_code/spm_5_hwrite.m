function [s] = spm_5_hwrite(P,DIM,VOX,SCALE,TYPE,OFFSET,ORIGIN,DESCRIP)
% writes a header
% FORMAT [s] = spm_5_hwrite(P,DIM,VOX,SCALE,TYPE,OFFSET,ORIGIN,DESCRIP);
%
...
%
% spm_5_hwrite writes variables from working memory into a SPM/ANALYZE
...
%
% see also dbh.h (ANALYZE) spm_hread.m and spm_5_type.m
%
%__________________________________________________________________________
% @(#)spm_5_hwrite.m	2.3 00/02/22
...
mach = 'native';
if ~isnan(spm_5_type(TYPE,'swapped'))
  if spm_5_type(TYPE,'swapped'),
	if spm_platform('bigend'),
		mach = 'ieee-le';
	else,
		mach = 'ieee-be';
	end;
	TYPE = spm_5_type(spm_5_type(TYPE));
  end;
end;

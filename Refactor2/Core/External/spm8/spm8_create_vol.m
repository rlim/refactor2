...
if ~isfield(V,'dt'),
%    V.dt = [spm8_type('float64') spm_platform('bigend')];
    V.dt = [spm8_type('float64') isBigendian()];
end;

dt{1} = spm8_type(V.dt(1));
...
[pth,nam,ext] = spm8_fileparts(V.fname);
